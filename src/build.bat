...
set CommonLinkerFlags= /INCREMENTAL:NO -opt:ref winmm.lib GLFW.lib glad.lib opengl32.lib user32.lib gdi32.lib shell32.lib dsound.lib
...
REM 64-bit build
cl  %CommonCompilerFlags% /LD ..\src\game.cpp %IncludePaths% 
