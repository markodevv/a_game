...
set win32_compiler_flags= -I ..\third_party\stb\ -DEBUG -Gm- -GR- -EHa- -Od -Oi -WX -W3 -wd4996 -wd4311 -wd4302 -wd4201 -wd4100 -wd4189 -wd4129 -wd4244 -DPLATFORM_WIN32=1 -DGAME_DEBUG=1 -FC -Z7 -MTd -nologo
